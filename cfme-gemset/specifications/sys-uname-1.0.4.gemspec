...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGES".freeze, "README".freeze, "MANIFEST".freeze, "doc/uname.txt".freeze]
  s.files = ["CHANGES".freeze, "MANIFEST".freeze, "README".freeze, "doc/uname.txt".freeze]
